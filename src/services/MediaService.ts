...
class MediaService {
    ...
    async scanMediaFiles(): Promise<MediaCollection> {
        try {
    ...
    private async scanDirectory(directoryPath: string, depth = 0, maxDepth = 3): Promise<MediaCollection> {
        const media: MediaCollection = { audio: [], video: [] };
